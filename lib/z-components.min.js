/*! z-components v1.0.1 | (c) 2019-present zhowiny | MIT */
(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?module.exports=f():typeof define==='function'&&define.amd?define(f):(g=g||self,g['z-components']=f());}(this,function(){'use strict';function _defineProperty(obj, key, value) {
  if (key in obj) {
...
}, __vue_inject_styles__$3, __vue_script__$3, __vue_scope_id__$3, __vue_is_functional_template__$3, __vue_module_identifier__$3, browser, undefined);var components = {
  zButton: zButton,
  zDialog: zDialog,
  zIcon: zIcon,
  zMask: zMask
